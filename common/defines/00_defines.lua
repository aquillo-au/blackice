...
NMilitary = {
	...
	PLAN_SPREAD_ATTACK_WEIGHT = 1.0,						-- DNM, original 13 (AI overhaul mod) -- The higher the value, the less it should crowd provinces with multiple attacks.
...
NAI = {
	...
	VARIANT_UPGRADE_MIN_XP = 499,						-- Need to have it 499 since air & navy dont go to 800 -- Minimum XP before attempting to create a new variant.
	...
	AI_FRONT_MOVEMENT_FACTOR_FOR_READY = 0.3,			-- If less than this fraction of units on a front is moving, AI sees it as ready for action	
	...
	HOUR_BAD_COMBAT_REEVALUATE = 24,                  		-- DNM, original 60.0 (ai overhaul mod) -- if we are in combat for this amount and it goes shitty then try skipping it 
	...
	MIN_UNITS_FACTOR_FRONT_ORDER = 1.5,					-- Factor for min number of units to assign to area front orders
