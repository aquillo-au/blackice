...
NMilitary = {
	...
	FIELD_MARSHAL_DIVISIONS_CAP = 25,			-- how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
...
NAI = {
	...
	PLAN_VALUE_TO_EXECUTE = 0.22,						-- AI will typically avoid carrying out a plan it below this value (0.0 is considered balanced).
	...
	PLAN_FRONT_SECTION_MAX_LENGTH = 22,					-- When a front is longer than this it will be split in two sections for the AI
