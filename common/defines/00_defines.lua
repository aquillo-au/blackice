...
NAI = {
	...
	CALL_ALLY_conservatism_DESIRE = 50,					-- Desire to call ally added for conservatism AI
	...
	JOIN_ALLY_conservatism_DESIRE = 50,					-- Desire to join ally added for conservatism AI
