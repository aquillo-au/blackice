...
NGraphics = {
	...
	ROOT_FRONT_OFFSET = 1.5,							-- 1.5 How far the defensive line is offset from the front.
	...
	BORDER_COLOR_DEMILITARIZED_R = 1.0, -- 1.0
	BORDER_COLOR_DEMILITARIZED_G = 0.06, -- 0.06
	BORDER_COLOR_DEMILITARIZED_B = 0.0, -- 0.0
	BORDER_COLOR_DEMILITARIZED_A = 0.9, -- 0.9
	...
	VICTORY_POINT_MAP_ICON_AFTER = {0, 2, 3, 10}, -- VP levels dependent. After this amount of VP the map icon becomes bigger dot.
	VICTORY_POINT_MAP_ICON_TEXT_CUTOFF = {150, 250, 500, 500},  -- At what camera distance the VP name text disappears.
	VICTORY_POINTS_DISTANCE_CUTOFF = {100, 150, 500, 1500}, -- At what distance VPs are hidden
	...
	MAPICON_GROUP_PASSES = 7, -- how many mapicons get processed per frame for grouping. more = quicker response, fewer = better performance
...
NSound = {
	...
	BATTLE_SOUND_FALLOFF_DEFAULT = 1.0,
