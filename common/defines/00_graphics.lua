...
NGraphics = {
	...
	CAPITAL_INDICATOR_HEIGHT_SCALE = 1400.0,
	...
	VICTORY_POINT_MAP_ICON_TEXT_CUTOFF = {150, 300, 650, 1200},  -- 200, 500, 1000 At what camera distance the VP name text disappears.
	VICTORY_POINTS_DISTANCE_CUTOFF = {125, 275, 625, 1000}, -- At what distance VPs are hidden
