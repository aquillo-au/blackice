...
NGraphics = {
	...
	LIGHT_HDR_RANGE = 1.0,
	BORDER_WIDTH = 1.2,
	PROVINCE_BORDER_FADE_NEAR = 150,
	PROVINCE_BORDER_FADE_FAR = 250,
	...
	VICTORY_POINT_MAP_ICON_AFTER = {0, 15, 30, 50}, -- After this amount of VP the map icon becomes bigger dot.
	VICTORY_POINT_MAP_ICON_TEXT_CUTOFF = {180, 350, 650, 1200},  -- 200, 500, 1000 At what camera distance the VP name text disappears.
	VICTORY_POINTS_DISTANCE_CUTOFF = {150, 300, 500, 1000}, -- At what distance VPs are hidden
