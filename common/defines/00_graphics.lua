...
NGraphics = {
	...
	VICTORY_POINT_MAP_ICON_AFTER = {0, 15}, -- VP levels dependent. After this amount of VP the map icon becomes bigger dot.
	VICTORY_POINT_MAP_ICON_TEXT_CUTOFF = {100, 250, 500},  -- At what camera distance the VP name text disappears.
	VICTORY_POINTS_DISTANCE_CUTOFF = {150, 500, 1500}, -- At what distance VPs are hidden
